import {
    ...
    PRODUCT_LIST_FAIL, PRODUCT_LIST_REQUEST, PRODUCT_LIST_SUCCESS, PRODUCT_UPDATE_FAIL,
...
export const reviewProduct = ({ productId, rating, comment }) => async (dispatch, getState) => {
    try {
